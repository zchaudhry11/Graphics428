...
float CompositeBenchmarkTechniquePLE::_computeTotalBenchmarkScore(SimulationMetricsCollector * simulationMetrics) 
{
	...
	std::cout << "\n";
	std::cout << "             total number of agents: " << (unsigned int)_numCollisionsOfAllAgents << "\n";
	std::cout << "avg. number of collisions per agent: " << _numCollisionsOfAllAgents / _numAgents << "\n";
	std::cout << "    average time spent by one agent: " << _totalTimeOfAllAgents / _numAgents << "\n";
	std::cout << "  average energy spent by one agent: " << _totalEnergyOfAllAgents / _numAgents << "\n";
	std::cout << " sum of instantaneous accelerations: " << _totalInstantaneousAcceleration / _numAgents << "\n";
	std::cout << "(alpha, beta, gamma, delta) weights: " << "(" << _alpha << "," << _beta << "," << _gamma << "," << _delta << ")\n";
	std::cout << "                       weighted sum: " << _alpha << "*" << _numCollisionsOfAllAgents / _numAgents << " + " << _beta << "*" << _totalTimeOfAllAgents / _numAgents << " + " << _gamma << "*" << _totalEnergyOfAllAgents / _numAgents << " + " << _delta << "*" << _totalInstantaneousAcceleration / _numAgents << " = " << _totalBenchmarkScore << "\n";
